...
const ProductDetails = () => {
  ...
  return (
    <div className="product-page">
      <nav className="breadcrumb">Account / Gaming / <span>Havic HV G-92 Gamepad</span></nav>

      <div className="product-main">

        <div className="image-gallery">
          <div className="thumbnails">
            <div className="thumb"><img src="thumb1.png" alt="" /></div>
            <div className="thumb"><img src="thumb2.png" alt="" /></div>
            <div className="thumb"><img src="thumb3.png" alt="" /></div>
            <div className="thumb"><img src="thumb4.png" alt="" /></div>
          </div>
      ...
      <div className="related-section">
        ...
        <div className="product-grid">
           ...
           <div className="product-card">
              ...
              <div className="card-image"><img src="gamepad-red.png" alt="" /></div>
              <button className="add-to-cart">Add To Cart</button>
              <h3>HAVIT HV-G92 Gamepad</h3>
              <div className="card-price">$120 <span>$160</span></div>
